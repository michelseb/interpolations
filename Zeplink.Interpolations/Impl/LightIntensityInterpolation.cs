...
namespace ZepLink.Interpolations.Impl
{
    ...
    {
        public LightIntensityInterpolation(Light2D light, float value, Func<float> origin, Func<float> target, float duration) : base(light, value, origin, target, duration) { }
